...
class Home extends Component {
    ...
    componentWillMount() {
        ...
        xhr.setRequestHeader("Access-Control-Allow-Headers", "Access-Control-Allow-Headers, Origin,Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers, X-Auth-Token");
       ...
       // xhr.responseType = "application/json";
        ...
        xhrReleased.setRequestHeader("Access-Control-Allow-Credential", "true");
        ...
        xhrGenres.setRequestHeader("Access-Control-Allow-Credential", "true");
        ...
        xhrArtists.setRequestHeader("Access-Control-Allow-Credential", "true");
